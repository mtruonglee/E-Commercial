<template>
  <div class="container-fluid px-5 py-5" v-if="products.length > 0" style="background-color: rgb(241, 241, 241);">
    <div class="row">
      <div class="col-3">
        <div class="dropdown">
          <a class="nav-link dropdown-toggle fw-bolder" href="#" role="button" data-bs-toggle="dropdown"
            aria-expanded="false" data-bs-auto-close="false">
            Category
          </a>
          <div class="position-relative">
            <ul class="dropdown-menu position-static" data-bs-reference="parent"
      ...
      <div class="col-9 ps-5">
        ...
        <form action="" class="flex gap-4 items-center mb-4 mt-2">
          <div class="row flex items-center gap-2">
            <span>Price: </span>
            <select :value="priceRef" @change="onSortPrice($event)"
          ...
          <div class="row flex items-center gap-2">
            <span>Version: </span>
            <select :value="versionRef" @change="onSortVersion($event)"
              class="bg-gray-50 border-gray-800 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        <div class="flex justify-center gap-4 items-center mt-4 relative" v-if="pagination">
          <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
            <button @click="prevPage(pagination)"
